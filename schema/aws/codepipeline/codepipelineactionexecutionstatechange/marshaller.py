...
import re
import six
import schema.aws.codepipeline.codepipelineactionexecutionstatechange
    ...
    def unmarshall(cls, data, typeName):
        ...
        if type(typeName) == str:
            ...
            if typeName in cls.NATIVE_TYPES_MAPPING:
                ...
                typeName = getattr(schema.aws.codepipeline.codepipelineactionexecutionstatechange, typeName)
